...
- Remote CI and the final release commit must be verified before tagging; final results are
  recorded during release preparation, never inferred from local results.
